      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Elevate your possibilities with Stakweb Limited – where innovation meets excellence for a future defined by success.
                </p>
          ...
          <div className="py-8">
            ...
            © 2023 Stakweb Technology Company Limited{" "}
